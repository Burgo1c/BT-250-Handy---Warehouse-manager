...
(function() {
	...
	ScanLib.Setting.btScanSetProperty = function( id, obj )
	{
		...
		switch(id)
		{
			...
			case Bt.LibDef.BT_SCAN_PROP_COMPOSITE:			// Composite symbol property
				...
				break;
			case Bt.LibDef.BT_SCAN_PROP_JAN_EX:				// Extended JAN property
				btScanLib_X.JanEx = obj.prop;
				break;
			case Bt.LibDef.BT_SCAN_PROP_TOF_EX:				// TOF extended property
				btScanLib_X.TofEx = obj.prop;
				break;
			...
			case Bt.LibDef.BT_SCAN_PROP_LIVEVIEW_DECODING:		// [2D]Display liveview decoding
				...
				break;
			case Bt.LibDef.BT_SCAN_PROP_ATTACHIMENT:			// [2D]Light extended attachment
				btScanLib_X.ExtendedAttachment = obj.prop;
				break;
			...
			case Bt.LibDef.BT_SCAN_PROP_DISTANCE_LED:			// [[2D]Reading distance display LED
				...
				break;
			case Bt.LibDef.BT_SCAN_PROP_EXT_LOW_DIRECTION:		// [2D]Low Angle Direction
				btScanLib_X.ScanPropExtLowDirection = obj.prop;
				break;
			...
			case Bt.LibDef.BT_SCAN_PROP_OCR_MIRROR:				// Mirror
				...
				break;
			case Bt.LibDef.BT_SCAN_PROP_OCR_MIXED_POL_MODE:		// Mixed Polarity
				btScanLib_X.ScanPropMixedPolMode = obj.prop;
				break;
	...
	{
		if( id == Bt.LibDef.BT_SCAN_PROP_OCR_DFORMAT ){
			btScanLib_X.Dformat_FormatNumber = obj.FormatNumber;
		}
		...
		if (ret == Bt.LibDef.BT_OK){
			...
			switch(id)
			{
				...
				case Bt.LibDef.BT_SCAN_PROP_COMPOSITE:			// Composite symbol property
					...
					break;
				case Bt.LibDef.BT_SCAN_PROP_JAN_EX:				// Extended JAN property
					obj.prop = btScanLib_X.JanEx;
					break;
				case Bt.LibDef.BT_SCAN_PROP_TOF_EX:				// TOF extended property
					obj.prop = btScanLib_X.TofEx;
					break;
				case Bt.LibDef.BT_SCAN_PROP_ENABLE_SYMBOLS:		// Code permitted to read
				...
				case Bt.LibDef.BT_SCAN_PROP_LIVEVIEW_DECODING:		// [2D]Display liveview decoding
					...
					break;
				case Bt.LibDef.BT_SCAN_PROP_ATTACHIMENT:			// [2D]Light extended attachment
					obj.prop = btScanLib_X.ExtendedAttachment;
					break;
				case Bt.LibDef.BT_SCAN_PROP_TARGET_BRIGHTNESS:		// [2D]Target brightness
				...
				case Bt.LibDef.BT_SCAN_PROP_DISTANCE_LED:			// [2D]Reading distance display LED
					...
					break;
				case Bt.LibDef.BT_SCAN_PROP_EXT_LOW_DIRECTION:		// [2D]Low Angle Direction
					obj.prop = btScanLib_X.ScanPropExtLowDirection;
					break;
				case Bt.LibDef.BT_SCAN_PROP_LASER_MODE:			// [1D]Laser mode
				...
				case Bt.LibDef.BT_SCAN_PROP_OCR_MIRROR:				// Mirror
					...
					break;
				case Bt.LibDef.BT_SCAN_PROP_OCR_MIXED_POL_MODE:		// Mixed Polarity
					obj.prop = btScanLib_X.ScanPropMixedPolMode;
					break;
	...
	ScanLib.Setting.btScanSetOCRFormatEach = function( index, obj )
	{
		...
		btScanLib_X.Dformat_Each_reserve = obj.L_alphabets;
