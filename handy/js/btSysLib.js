		...
		if (ret == Bt.LibDef.BT_OK){
			...
			switch(id)
			{
				...
				case Bt.LibDef.BT_SYS_PRM_SERIALNO:					// Serial number
					...
					break;
				case Bt.LibDef.BT_SYS_PRM_WAKEUP_ROUTE:				// [WakeUp] Communication route
					obj.value = btSysLib_X.HandyParamWakeupRoute;
					break;
				case Bt.LibDef.BT_SYS_PRM_WAKEUP_PORT:				// [WakeUp] Communication port
					obj.value = btSysLib_X.HandyParamWakeupPort;
					break;
				case Bt.LibDef.BT_SYS_PRM_KIOSK_ENABLE:				// KIOSK mode
					obj.value = btSysLib_X.HandyParamKioskEnable;
					break;
				case Bt.LibDef.BT_SYS_PRM_KIOSK_DESKTOPIMAGE:		// KIOSK mode desktop image
					obj.value = btSysLib_X.HandyParamKioskDesktopImage;
					break;
				case Bt.LibDef.BT_SYS_PRM_DESIGNTOOL_TYPE:			// DesignTool support type
					obj.value = btSysLib_X.HandyParamDesignToolType;
					break;
				default:
					break;
			}
